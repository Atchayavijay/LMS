...
const InstructorSidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    { to: '/instructor-dashboard/create-course', icon: PlusCircle, label: 'Create Course' },
    { to: '/instructor-dashboard/students', icon: Users, label: 'Students' },
    { to: '/instructor-dashboard/content', icon: FileText, label: 'Assignments' },
    { to: '/instructor-dashboard/analytics', icon: BarChart3, label: 'Analytics' },
