  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-start pt-28 md:pt-32 lg:pt-36 xl:pt-44 pb-16">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        {/* CTA Button */}
        <button className="mt-8 inline-flex items-center gap-2 bg-black text-white px-6 py-3 md:px-8 md:py-3 rounded-full text-sm md:text-[16px] font-semibold hover:bg-gray-900 transition">
          Start Learning
