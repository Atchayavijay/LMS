    ...
    >
      ...
      <div className="mt-auto px-1">
        ...
        <div className="flex items-center justify-between pb-1">
          ...
          <Link to="/course-details" className="bg-gradient-to-r from-[#D63384] to-[#FF3FB4] hover:opacity-90 text-white text-[11px] font-bold px-4 py-2 rounded-full transition-all flex-shrink-0 shadow-lg shadow-pink-500/10">
            View details
          </Link>
        </div>
      </div>
