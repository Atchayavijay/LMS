    ...
    return (
        <div className="min-h-screen bg-[#0c091a] flex items-center justify-center p-4">
             <div className="max-w-md w-full bg-white/[0.03] border border-white/5 rounded-[32px] p-8 text-center">
                 <div className="w-20 h-20 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto mb-6 text-yellow-500 animate-pulse">
                     <Clock size={40} />
                 </div>
                 ...
                 <p className="text-white/60 mb-8">
                     ...
                     <br/><br/>
                     Status: <span className="text-yellow-400 font-bold uppercase tracking-wider text-xs">Pending Approval</span>
                 </p>
