...
const BlogCard = ({ article, alignment = 'left', variant = 'large' }) => {
  ...
  return (
    <div 
      className={`group relative flex flex-col w-[95%] mx-auto border border-white/10 rounded-[40px] p-5 transition-all duration-300 hover:scale-[1.02] hover:border-[#FF3FB4] hover:shadow-[0_0_30px_rgba(255,63,180,0.6)] backdrop-blur-[4px] shadow-2xl overflow-hidden ${isCentered ? 'items-center text-center' : 'items-start text-left'}`} 
