...
/**
 * Reviews tab for managing student course reviews
 */
const ReviewsTab = () => {
    return (
        <div className="space-y-8 animate-in slide-in-from-right-4 duration-500 pb-20 font-satoshi">
            <div className="space-y-1">
                <h1 className="text-2xl font-black text-white italic">Reviews</h1>
                <p className="text-[12px] text-white/40 font-medium">List of all the reviews by the students</p>
            </div>
            ...
            <Card className="rounded-[24px] overflow-hidden">
                ...
                <EmptyState 
                    message="Student reviews will appear here when submitted"
                />
            </Card>
        </div>
    );
